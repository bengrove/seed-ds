...
🚧 **Coming soon.** Real code composition snippets will be regenerated from [seed-health/my-seed-live → components](https://github.com/seed-health/my-seed-live/tree/main/components) and the [hosted Storybook](https://www.chromatic.com/library?appId=63b5c3a4b545db5441de378b) once the dev refactor settles — same window as `components.md`.
...
5. **Assets** — use the right CDN per surface per [`assets.md`](./assets.md) (Cloudinary for editorial, Shopify for PDP/checkout).
